...
const Services = () => {
    return (
        <section class="text-white body-font bg-[#090119] lg:min-h-screen xl:min-h-screen overflow-hidden">
            <div class="px-10 lg:px-24 pr-24 lg:pr-36 pb-16 pt-10 mx-auto ">
                ...
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 md:w-1/2 lg:w-1/3 w-full relative sm:mb-12 lg:mb-0">
                        <div className="animate__animated animate__zoomIn animate__slow h-full p-8 rounded-lg shadow-lg shadow-slate-800 border-l-[5px] border-l-pink-700">
                            ...
                            <p className="leading-relaxed mt-5">I design and build websites. I am typically responsible for the appearance, of the site and technical aspects, such as site speed and how much traffic the site can handle. </p>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/2 lg:w-1/3 w-full relative sm:mb-12 lg:mb-0">
                        <div className="animate__animated animate__zoomIn animate__slow h-full p-8 rounded-lg shadow-lg shadow-slate-800 border-l-[5px] border-l-pink-700">
                            ...
                            <p className="leading-relaxed mt-5">I am responsible for developing new user-facing features, determining the structure and design of web pages, building reusable codes, and using a variety of markup languages to create the web pages.</p>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/2 lg:w-1/3 w-full relative sm:mb-12 lg:mb-0">
                        <div className="animate__animated animate__zoomIn animate__slow h-full p-8 rounded-lg shadow-lg shadow-slate-800 border-l-[5px] border-l-pink-700">
                            ...
                            <p className="leading-relaxed mt-5">I design and implement user interface components for JavaScript-based web and mobile applications using the React open-source library ecosystem. </p>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/2 lg:w-1/3 w-full relative">
                        <div className="animate__animated animate__zoomIn animate__slow h-full p-8 rounded-lg shadow-lg shadow-slate-800 border-l-[5px] border-l-pink-700 mt-8">
                            ...
                            <p className="leading-relaxed mt-5">I am also responsible for designing user interactions on websites, developing servers, and databases for website functionality, and coding for mobile platforms. </p>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/2 lg:w-1/3 w-full relative ">
                        <div className="animate__animated animate__zoomIn animate__slow h-full p-8 rounded-lg shadow-lg shadow-slate-800 border-l-[5px] border-l-pink-700 mt-8">
                            ...
                            <p className="leading-relaxed mt-5">REST API is a programming interface that strictly interacts with a REST architectural style. I have good knowledge for creating REST API systems for companies.</p>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/2 lg:w-1/3 w-full relative">
                        <div className="animate__animated animate__zoomIn animate__slow h-full p-8 rounded-lg shadow-lg shadow-slate-800 border-l-[5px] border-l-pink-700 mt-8">
                            ...
                            <p className="leading-relaxed mt-5">Firebase supports authentication using passwords, popular federated identity providers like Google and Facebook. I have good knowledge for implementing firebase authentication. </p>
                        </div>
                    </div>
                </div>
            </div>
