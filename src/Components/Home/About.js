...
const About = () => {
    return (
        <section class="body-font overflow-hidden bg-black bg-opacity-92">
            <div class="container py-24 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <div class="lg:w-1/2 w-full lg:py-6 mb-6 lg:mb-0">
                        ...
                        <p className='text-white text-justify mb-12'>I am Arfat. I've been in the Web Development field for the last 1.5 years with enough experience and extensive knowledge in React js, HTML5, CSS, JavaScript, JavaScript ES6, Tailwind CSS, Bootstrap, Firebase, Figma and Adobe Photoshop and Illustrator. For the last 1 year, I am also working as a full-stack developer with back-end technologies like Node js, Express I am highly motivated and I love to get work done in a quick manner. I love learning new skills and I am excited to work with clients. Drop a message and let's get started. I am also available for permanent work.</p>
                    ...
                    <div class="lg:w-1/2 w-full pl-24 lg:py-6 mb-6 lg:mb-0 mx-auto">
                        <img alt="ecommerce" class="w-full -mt-28 border border-3 border-pink-700 px-12 pt-12 mx-auto lg:h-auto object-cover object-center rounded" src="https://i.ibb.co/sQ3JhwJ/me.png" />
                    </div>
                </div>
            </div>
        </section>
